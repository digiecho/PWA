let database,admin,moment,usersUtil;_155‍.x([["default",()=>_155‍.o]]);_155‍.w("firebase-functions",[["database",["database"],function(v){database=v}]]);_155‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);_155‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_155‍.w("firebase-function-tools/lib/users",[["default",["usersUtil"],function(v){usersUtil=v}]]);




_155‍.d(database.ref('/users_count').onDelete((data, context) => {
