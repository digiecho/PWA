let database,admin;_155‍.w("firebase-functions",[["database",["database"],function(v){database=v}]]);_155‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);
  ...
  .onWrite((eventSnapshot, context) => {
    ...
    return roleGrantsRef.once('value').then(snapshot => {
      ...
      snapshot.forEach(grant => {
        ...
        _155‍.g.console.log('User role changed:', eventSnapshot.after.val())
